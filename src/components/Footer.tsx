        ...
        <div className={styles.grid}>
          ...
          <div className={styles.brandCol}>
            ...
            <div className={styles.socials}>
              ...
              <a href="https://www.instagram.com/s.s.h.p.school?igsh=NDh5Nmpjcmtwang2" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="Instagram">
